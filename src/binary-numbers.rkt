...
;; Backward-compatible alias used in existing miniKanren examples.
(defrel (>1o n)
  (gt1o n))

(defrel (add3o b x y r c)
  (conde
    [(== 0 b) (== 0 x) (== 0 y) (== 0 r) (== 0 c)]
    [(== 1 b) (== 0 x) (== 0 y) (== 1 r) (== 0 c)]
    [(== 0 b) (== 1 x) (== 0 y) (== 1 r) (== 0 c)]
  ...
  (conde
    ...
    [(== '(1) n) (== '(1) m)
     (fresh (a c)
       (== `(,a ,c) r)
       (add3o d 1 1 a c))]
    [(== '(1) n) (add-carry-stepo d n m r)]
    [(== '(1) m) (gt1o n) (gt1o r)
     (add-carryo d '(1) n r)]
    [(gt1o n) (add-carry-stepo d n m r)]))

(defrel (addero d n m r)
  (add-carryo d n m r))

(defrel (add-carry-stepo d n m r)
  (fresh (a b c e x y z)
    (== `(,a . ,x) n)
    (== `(,b . ,y) m) (poso y)
    (== `(,c . ,z) r) (poso z)
